...
package com.example.lab2_reyes_a.db.utils;
...
//                                final RegistrationForm user, final Book book, Date from, Date to) {
//        Loan loan = new Loan();
//        loan.id = id;
//        loan.bookId = book.id;
//        loan.userId = user.id;
...
//    }
//
//    private static RegistrationForm addUser(final AppDatabase db, final String id, final String name,
...
//
//        RegistrationForm user1 = addUser(db, "1", "Jason", "Seaver", 40);
//        RegistrationForm user2 = addUser(db, "2", "Mike", "Seaver", 12);
